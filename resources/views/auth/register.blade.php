                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input id="Buyer" value="Buyer" type="radio" class="form-check-input" name="user_pos" required checked>
                                    <label class="form-check-label" for="Buyer">Buyer</label>
                                </div>
                                <div class="form-check">
                                    <input id="Seller" value="Seller" type="radio" class="form-check-input" name="user_pos" required>
